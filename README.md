...
Preprocessed and engineered features from raw traffic datasets. 
Performed exploratory data analysis (EDA) and feature selection. 
Evaluated models using MAE, RMSE, MAPE, and R² metrics. 
Delivered a comprehensive analysis report with model comparison and performance justification.
